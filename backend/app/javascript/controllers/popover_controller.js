...
export default class extends Controller {
  ...
  connect() {
    ...
    this.popoverElement.className =
      "popover-content shadow-lg absolute text-sm bg-white dark:bg-gray-800 rounded-lg opacity-0 pointer-events-none z-[9999] ring-1 ring-black/5 dark:ring-white/10";
    ...
    if (this.hasArrowValue) {
      ...
      this.arrowElement.className = "popover-arrow w-3 h-3 rotate-45 bg-white dark:bg-gray-800 ring-1 ring-black/5 dark:ring-white/10";
      ...
      this.cleanupAutoUpdate = autoUpdate(
        ...
        async () => {
          ...
          if (this.hasArrowValue && this.arrowContainer && this.arrowElement && middlewareData.arrow) {
            ...
            // Just positioning the arrow so it pokes out correctly
            // The shadow and ring on the popover body handles the rest
          }
        },
        { animationFrame: true },
      );
